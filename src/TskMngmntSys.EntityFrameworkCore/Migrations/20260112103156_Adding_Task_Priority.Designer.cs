...
namespace TskMngmntSys.Migrations
{
    ...
    [Migration("20260112103156_Adding_Task_Priority")]
    partial class Adding_Task_Priority
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TskMngmntSys.Entities.Task.TaskItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("TskMngmntSys.EntityFrameworkCore.QueryModels.TaskProgressReport", b =>
                {
            ...
            modelBuilder.Entity("Abp.Authorization.Roles.RoleClaim", b =>
                {
                    b.HasOne("TskMngmntSys.Authorization.Roles.Role", null)
                        .WithMany("Claims")
            ...
            modelBuilder.Entity("Abp.Authorization.Users.UserClaim", b =>
                {
                    b.HasOne("TskMngmntSys.Authorization.Users.User", null)
                        .WithMany("Claims")
